...
export const UI_COPY = {
  zh: {
    ...
    hunterClaimHelp: '验证一次邮箱即解锁榜上昵称 / 简介 / X 账号，此后改档案无需登录',
    hunterClaimStart: '开始认领',
    hunterClose: '关闭',
  ...
  en: {
    ...
    hunterClaimHelp: 'Verify your email once to unlock the name / bio / X handle on the board — no sign-in afterwards',
    hunterClaimStart: 'Start claim',
    hunterClose: 'Close',
