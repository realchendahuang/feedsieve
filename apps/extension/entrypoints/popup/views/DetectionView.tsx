...
import { AppIcon, HelpIcon, STRENGTH_HINTS, STRENGTH_LABELS } from './shared';

interface DetectionViewProps {
  language: UiLanguage;
  notify: (message: string | null) => void;
  community: CommunitySettings | null;
  onUpdateCommunity: (patch: { strength: MarkStrength }) => Promise<unknown>;
}
...
export default function DetectionView({
  ...
  return (
    <div className="view-stack detection-view">
